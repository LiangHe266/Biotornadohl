...
Pager.prototype.update = function (count) {
    ...
    var delayFunc = function () {
        ...
        angular.element(pgId + "#" + pageIndex).addClass("active").css("background","#f70");
    };
...
var getBaseUrl = function () {
    //return "http://120.25.124.115:8086/mdt/"//云服务器
    //return "http://192.168.1.10:8086/mdt/" //公司服务器
    return myURL.getBaseUrl() + ':85/mdt/'
};
